(function() {
  ...
  function isValid(infoObj) {
    ...
    return new Success(R.curryN(4, function() {
        return infoObj;
      }))
      .ap(Check.Object(infoObj))
      .ap(Check.Object(infoObj.data))
      .ap(Check.Object(infoObj.data.translatedString))
      .ap(Check.String(infoObj.data.translatedString.code));
  }
